...
<a class="navbar-brand ml-20" href="#"><img src="images/logo.jpg" height="80px" width="80px"></img></a>
...
<!-- notice -->
<section class="ml-12" style="margin-left:110px"> 
...
<!-- add event -->
<div class="flex-second-section mt-10" id="addevent">
                  ...
                  <tr>
                    ...
                    <td><div align="right">
                        ...
                        <input type="hidden" name="event_name" value="<?php echo isset($rows['Event_name']) ? $rows['Event_name'] : ''; ?>">
                                 <button class="btn btn-sm btn-danger active delete-club" style="width:100px;" name="delete_event"  type="submit">Reject
                                  <!-- <i class="fa-sharp fa-solid fa-circle-xmark fa-xl"></i> -->
                        </button>
                        </form>
                      </div></td>
