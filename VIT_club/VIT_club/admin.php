...
<!-- vertical nav -->
<div>
<nav class ="navbar bg-light align-text-top" style="width:350px;height:3500px;margin-top:1px">
  <ul class ="nav navbar-nav text-xl mx-16"  style="margin-top:-3000px">
   <li class ="nav-item">
...
<div>
  <div>
<!--create club-->
<section class="vh-50 position-relative">
...
<!--existing clubs -->
<section class="vh-50" id="existingclubs">
  <div class="container py-5 h-50">
    <div class="row justify-content-center align-items-center h-50">
      <div class="col-12 col-lg-5 col-xl-9">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px">
                ...
                <td>
                    <div align="center">
                        ...
                        <input type="hidden" name="club_id" value="<?php echo isset($rows['club_id']) ? $rows['club_id'] : ''; ?>">
                              <button class="btn btn-sm btn-danger active delete-club" style="width:100px;margin-left:-40px;"   type="submit">Remove club
...
<!-- Existing moderators-->
<section class="vh-50" id="existingmoderators">
  <div class="container py-5 h-50">
    <div class="row justify-content-center align-items-center h-50">
      <div class="col-12 col-lg-5 col-xl-9">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
